...
const Navbar = ({ onLogout, user = {} }) => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-fuchsia-100 to-pink-300 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans">
      <div className="flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto">
        ...
        <div
          ...
          onClick={() => navigate("/")}
        >
          <div className="relative w-10 h-10 flex  items-center justify-center rounded-xl bg-gradient-to-br from-fuchsia-400 via-purple-500 to-indigo-500 shadow-lg group-hover:shadow-purple-300/50 group-hover:scale-105 transition-all duration-300">
        ...
        <div className="flex items-center gap-4">
          <button
            className="p-2 text-gray-8600 hover:text-purple-500 transition-colors duration-300 hover:bg-purple-50 rounded-full"
              ...
              <ul className="absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border-purple-100 z-50 overflow-hidden animate-fadeIn">
                <li className="p-2">
                  <button
                    ...
                    className="w-full flex items-center px-4 py-2.5 text-left hover:bg-purple-50 text-sm text-gray-700 transition-colors gap-2 group"
                    role="menuitem"
                  >
