...
const Layout = ({ onLogout, user }) => {
  ...
  const fetchTasks = useCallback(async () => {
    ...
    try {
      ...
      const { data } = await axios.get("https://taskmanager-backend-n7qg.onrender.com/api/task/gp", {
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="xl:col-span-1 space-y-4 sm:space-y-6">
            <div className="bg-white rounded-xl p-4 sm:p-5 shadow-md border border-purple-100">
              ...
              {/* <hr className="my-3 sm:py-4 border-purple-400" /> */}
              ...
              <div className="space-y-2 sm:space-y-3">
                {tasks.slice(0, 3).map((task) => (
                  ...
                  >
                    ...
                    <span
                      className={`p-2 py-2 text-xs rounded-full shrink-0 ml-2 
                        ${
                          task.completed
